          ...
          >
                  ...
                  <div className="flex flex-col flex-grow justify-between">
                    ...
                    <div className="flex justify-between items-end">
                      <div className="flex items-center gap-3 border border-[#EAE2D6] px-3 py-1">
                        <button className="text-[#27272A]/70 hover:text-[#BA2461]">-</button>
            ...
            <div className="p-6 border-t border-[#EAE2D6] bg-[#FDFBF7]">
              <div className="flex justify-between text-lg mb-6">
                ...
                <span className="font-serif text-[#BA2461]">₹3,198</span>
              </div>
              <p className="text-[#27272A]/60 text-xs mb-6 tracking-wide">Shipping & taxes calculated at checkout.</p>
              <button className="w-full py-4 bg-[#BA2461] text-[#FDFBF7] font-medium tracking-wide hover:bg-[#951C4D] transition-colors duration-300">
                Checkout
              </button>
            </div>
          </motion.div>
